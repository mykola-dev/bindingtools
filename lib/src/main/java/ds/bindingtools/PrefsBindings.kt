...
class PrefDelegate<T : Any>(private val default: T, private val cls: KClass<T>) : ReadWriteProperty<PreferencesAware, T> {

    @Suppress("unchecked_cast")
    override fun getValue(thisRef: PreferencesAware, property: KProperty<*>): T =
            thisRef.sharedPreferences.getGeneric(property.name, default, cls)
...
@Suppress("unchecked_cast")
private fun <T : Any> SharedPreferences.getGeneric(key: String, default: T, cls: KClass<T>): T = when (cls) {
